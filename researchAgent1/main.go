...
import (
	...
	"log"
	"encoding/json"
	configh "researchAgent1/internal/config"
	httpHandlers "researchAgent1/internal/handlers"
	tracingh "researchAgent1/internal/tracing"
...
// main is the entry point for the researchAgent1 multi-agent system.
//
...
func main() {
	...
	logger := core.Logger()
	logger.Info().Str("log_level", config.Logging.Level).Str("log_format", config.Logging.Format).Msg("Starting researchAgent1 multi-agent system with configured logging")
