...
func (f *ConfigurableAgentFactory) CreateAgentFromConfig(name string, globalConfig *Config) (Agent, error) {
	...
	resolver := NewConfigResolver(globalConfig)
...
func (f *ConfigurableAgentFactory) ValidateAgentConfiguration(name string) error {
	...
	resolver := NewConfigResolver(f.config)
	resolvedConfig, err := resolver.ResolveAgentConfigWithEnv(name)
	if err != nil {
...
func (f *ConfigurableAgentFactory) createLLMConfigFromResolved(resolved *ResolvedLLMConfig) LLMConfig {
	return LLMConfig{
...
func (f *ConfigurableAgentFactory) createLLMProviderFromConfig(llmConfig *ResolvedLLMConfig, globalConfig *Config) (ModelProvider, error) {
	if llmConfig == nil {
...
func (f *ConfigurableAgentFactory) createOpenAIProvider(providerConfig map[string]interface{}, llmConfig *ResolvedLLMConfig) (ModelProvider, error) {
...
func (f *ConfigurableAgentFactory) createAzureProvider(providerConfig map[string]interface{}, llmConfig *ResolvedLLMConfig) (ModelProvider, error) {
...
func (f *ConfigurableAgentFactory) createOllamaProvider(providerConfig map[string]interface{}, llmConfig *ResolvedLLMConfig) (ModelProvider, error) {
...
func (ca *ConfiguredAgent) Run(ctx context.Context, inputState State) (State, error) {
...
func (ca *ConfiguredAgent) GetLLMConfig() *ResolvedLLMConfig {
