...
// execute contains the core execution logic
...
func (a *realAgent) RunStream(ctx context.Context, input string, opts ...StreamOption) (Stream, error) {
	return a.executeStream(ctx, input, nil, opts...)
}

// executeStream contains the core streaming logic
func (a *realAgent) executeStream(ctx context.Context, input string, runOpts *RunOptions, opts ...StreamOption) (Stream, error) {
	if !a.initialized {
...
func (a *realAgent) RunStreamWithOptions(ctx context.Context, input string, runOpts *RunOptions, streamOpts ...StreamOption) (Stream, error) {
	...
	// Delegate to executeStream with the merged options
	return a.executeStream(ctx, input, runOpts, streamOpts...)
}
