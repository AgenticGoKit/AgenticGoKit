...
func NewAgent1(llmProvider agenticgokit.ModelProvider) *Agent1Handler {
...
//
// This is the main processing method for the Agent1 agent.
...
func (a *Agent1Handler) Run(ctx context.Context, event agenticgokit.Event, state agenticgokit.State) (agenticgokit.AgentResult, error) {
	...
	// Agent1 always processes the original input message
	...
	systemPrompt = `You are Agent1, processes tasks in sequence as part of a processing pipeline.
